...
argument-hint: "[--dry-run] [--from <filename-prefix>] [--objectives <dir>]"
...
For each PLANNED objective: new-milestone → autopilot → complete-milestone → PR → CI → merge → pull main.
</objective>
...
**Invocation:**
- As plugin: `/gsdu:milestone-runner [--dry-run] [--from <prefix>]`
</context>

<success_criteria>
- [ ] All PLANNED objectives processed sequentially
- [ ] Each milestone: created, autopiloted, completed
- [ ] Each milestone: PR created, CI passed, merged to main
- [ ] Main branch up-to-date after each merge
